				...
				if (mat < 31008) {
					...
					if (mat < 50048) {
						if (mat < 50000) {
							...
							if (mat < 50012) {
								if (mat < 50004) {
									// 50000: This case is probably superfluous (not in block.properties)
									emissive = true;
									...
									// 50004: This case is probably superfluous (not in block.properties)
									emissive = true;
								...
								if (mat < 50020) {
									// 50012: This case is probably superfluous (not in block.properties)
									emissive = true;
									...
									// 50020: This case is probably superfluous (not in block.properties)
									emissive = true;
						...
						if (mat < 60012) {
							if (mat < 60000) {
								if (mat < 50080) {
									// 50048: This case is probably superfluous (not in block.properties)
									emissive = true;
									...
									// 50080: This case is probably superfluous (not in block.properties)
									emissive = true;
