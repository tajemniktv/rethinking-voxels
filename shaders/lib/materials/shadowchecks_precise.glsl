...
bool getEntity(int mat) {
	return (mat / 10000 == 5);
}

bool getNoTrace(int mat) {
	return (
		mat == 1234 ||
		mat == 1235 ||
		mat == 10072 ||
...
ivec3[2] getBounds(int mat, vec3 pos) {
	ivec3 bounds[2] = ivec3[2](
		ivec3(0),
		ivec3(16)
	);
	switch (mat) {
